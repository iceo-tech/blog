...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_slug_-4eb39d32.js").then((m) => m.default || m)
  },
  {
    name: "post",
    path: "/post",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-ed4bd63e.js").then((m) => m.default || m)
  }
];
...
const euclidCirculara = "";
const swiper = "";
const magnify = "";
const odometer = "";
const animation = "";
const bootstrapSelect_min = "";
const jqueryUi = "";
const magnigyPopup_min = "";
const plyr = "";
const style = "";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-22fb01ea.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-40fe01fa.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-5f0ed118.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
