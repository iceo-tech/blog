...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><h1 data-v-0339d6c9>All Blog</h1><div class="popular_articles__block__heading__name__description" data-v-0339d6c9> Blog gi\xFAp c\xE1c nh\xE0 \u0111\xE0o t\u1EA1o m\u1EDBi x\xE2y d\u1EF1ng v\xE0 nu\xF4i d\u01B0\u1EE1ng c\u1ED9ng \u0111\u1ED3ng v\u1EEFng m\u1EA1nh t\u1EEB n\u1EC1n m\xF3ng. </div></div></div></div></div><div class="body_container" data-v-0339d6c9><div class="popular_articles__block__body container-fluid" data-v-0339d6c9><div class="row" data-v-0339d6c9><!--[-->`);
  ...
  if ((!$data.dataArticle || $data.dataArticle.length === 0) && !$data.isLoading) {
    _push(`<div class="advisor_category__empty w-100" data-v-0339d6c9><img${ssrRenderAttr("src", _imports_0)} data-v-0339d6c9><div class="advisor_category__empty__heading" data-v-0339d6c9> Danh s\xE1ch b\xE0i vi\u1EBFt tr\u1ED1ng! </div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
//# sourceMappingURL=index-ed4bd63e.mjs.map
