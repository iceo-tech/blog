import { version, unref, inject, hasInjectionContext, getCurrentInstance, useSSRContext, createApp, reactive, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, mergeProps, nextTick, defineComponent, ref, createElementBlock } from 'vue';
import { f as useRuntimeConfig$1, m as withQuery, n as hasProtocol, p as parseURL, o as isScriptProtocol, j as joinURL, i as createError$1, $ as $fetch, q as sanitizeStatusCode, r as createHooks } from '../nitro/node-server.mjs';
...
const axiosGetInstanceBackend = (url, config) => {
  return axios.get(url, {
    ...config
  }).catch((error) => {
    if (error && error.response && (Number(error.response.status) === 401 || Number(error.response.status) === 403)) {
...
class categoryClass {
  constructor() {
    __publicField(this, "getAllCategory", async (dataFilter) => {
      let config = {
        headers: {
    ...
    __publicField(this, "getCategoryBySlug", async (slug) => {
      if (!slug) {
        return null;
      }
      let config = {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-22fb01ea.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-40fe01fa.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-5f0ed118.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, axiosGetInstanceBackend as a, createError as c, entry$1 as default, injectHead as i, navigateTo as n, resolveUnrefHeadInput as r, useRouter as u };
